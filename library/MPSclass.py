...
class MPS(TNclass.TensorNetwork):
    ...
    # move mps central orthogonal Tensor to next
    # including normalization, cut virtual bond, svd decomposition, update the Tensor in MPS and it's just like the theory in video
    # the video link https://www.bilibili.com/video/BV17z411i7yM?p=11
    ...
    # move mps central orthogonal Tensor forward
